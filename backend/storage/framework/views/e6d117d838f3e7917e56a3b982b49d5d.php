        ...
        <div style="margin: auto;  width: max-content;  padding: 10px;">
            ...
            <table>
                <tr>
                    ...
                    <td>Tiêu đề:</td>
                    <td><?php echo e($tieuDe); ?>.</td>
                </tr>
                <tr>
                    <td>Nội dung:</td>
                    <td><?php echo e($noiDung); ?>.</td>
                </tr>
                <tr>
                    <td>Ngày xử lý:</td>
                    <td><?php echo e($ngayXuLy); ?>.</td>
                </tr>
                <tr>
                    <td>Nội dung xử lý:</td>
                    <td><?php echo e($noiDungXuLy); ?>.</td>
                </tr>
...
<?php /**PATH D:\laragon\www\datvexemphim\backend\resources\views/mail/sendEmailFeedback.blade.php ENDPATH**/ ?>