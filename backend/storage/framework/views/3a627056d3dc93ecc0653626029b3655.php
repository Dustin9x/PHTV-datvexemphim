...
<body style="margin: auto;  width: 80%;  padding: 10px;">
    <div style=" background-color:rgb(174, 174, 174)">
        <div style="padding-top: 20px; opacity: 0.8; text-align: center">
            <span style="font-size: 40px">
                <img style="width: 70px" src="<?php echo e($message->embed('images/logo.png')); ?>">

            </span>
            <span style="font-size: 40px">
                <img style="width: 130px" src="<?php echo e($message->embed('images/name.png')); ?>">
    ...
    <div style="margin: auto;  background-color: aliceblue; padding: 30px ">
        ...
        <div style="margin: auto;  width: max-content;  padding: 10px;">
            ...
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo e($rapChieu.', '.$phim.', '.$gioChieu.', '.$ngayChieu.', '.$danhSachGhe.', '.$name.', '.$email); ?>"
                width="150" />

            <table>
                <tr>
                    <td>Tên Phim :</td>
                    <td><?php echo e($phim); ?>.</td>
                </tr>
                <tr>
                    <td>Rạp:</td>
                    <td><?php echo e($rapChieu); ?>.</td>
                </tr>
                <tr>
                    <td>Ngày Chiếu:</td>
                    <td><?php echo e($ngayChieu); ?>.</td>
                </tr>
                <tr>
                    <td>Giờ Chiếu:</td>
                    <td><?php echo e($gioChieu); ?>.</td>
                </tr>
                <tr>
                    <td>Tổng Tiền:</td>
                    <td><?php echo e($tongTien); ?> Vnđ.</td>
                </tr>

                <tr>
                    <td>Ghế:</td>
                    <td><?php echo e($danhSachGhe); ?>.</td>
                </tr>
...
<?php /**PATH D:\laragon\www\datvexemphim\backend\resources\views/mail/sendEmail.blade.php ENDPATH**/ ?>