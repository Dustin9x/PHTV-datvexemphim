  ...
  return (
    <div>
      <div class="header__img-text">
        <h2 class=" text-white heading__text drop-shadow-md">Tuyển Dụng</h2>
        <div class="text-white end__text drop-shadow-md">Đồng Hành Cùng PHTV Việt Nam</div>
      </div>
        ...
        <div className="row">
          <div className="col-12">
            <div class="body">
              ...
              <p class="body_body">Lịch Sử Phát Triển</p>
              <ul class="history">
                <li class="history__list">
                  <p class="history__text">31/3/2023</p>
                ...
                <li class="history__list">
                  <p class="history__text">05/8/2023</p>
                  <p class="history__text">
                ...
                <li class="history__list">
                  <p class="history__text">07/8/2023</p>
                  <p class="history__text">
            ...
            <p class="body_body center">Kênh Tuyển Dụng</p>

            <div class="row">
              <div class="col-6 split__bar">
                <p class="body_body center">Khối Văn Phòng</p>
                <div class="image__office">
                  <img
                    src="https://www.cgv.vn/media/wysiwyg/web/icon_linkedin.png"
                    class="image__office-link"
                  ></img>
                  <img
              ...
              <div class="col-6">
                <p class="body_body center">Khối Cụm Rạp</p>
                <div class="image__office">
                  <img
            ...
            <p class="body_body center">Cách Thức Ứng Tuyển</p>

            <div class="row">
              <div class="col-6">
                <p class="body_body center">Vị Trí Toàn Thời Gian</p>
                <div class="application">
                  <p class="body_body center">Khối Văn Phòng / Cụm Rạp</p>
                  <p class="body_text">
              ...
              <div class="col-6">
                <p class="body_body center">Vị Trí Bán Thời Gian</p>
                <div class="application">
                  <p class="body_body center">Khối Cụm Rạp</p>
                  <p class="body_text">
            ...
            <p class="body_body">Lưu Ý : </p>
            <p class="body_text">PHTV KHÔNG thu bất kỳ chi phí tuyển dụng nào dưới mọi hình thức (phí hồ sơ, đồng phục….).</p>
            <p class="body_text">Với những vị trí cho khối Cụm Rạp, PHTV KHÔNG tuyển nhân viên thông qua đơn vị khác.</p>
          </div>
        </div>
      </div>
    </div>
