      ...
      <Form className="bg-white dark:bg-gray-900" onSubmitCapture={formik.handleSubmit}>
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <form action="#" className="space-y-8">
            ...
            <button type="submit" onSubmitCapture={formik.handleSubmit} className="py-3 px-5 font-medium text-center text-white rounded-lg bg-primary hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
          </form>
        </div>
      </Form>
