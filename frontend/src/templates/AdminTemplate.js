...
import { HomeOutlined,UserOutlined,BankOutlined, VideoCameraOutlined } from '@ant-design/icons';
...
const items = [
  ...
  getItem('Quản Lý Rạp', 'sub1', <BankOutlined />, [
    getItem('Hệ Thống Rạp', '3', <NavLink  className='text-decoration-none' to="/admin/theatremng"><BankOutlined /></NavLink>), 
    getItem('Rạp Chiếu', '4', <NavLink  className='text-decoration-none' to="/admin/theatrechildmng"><BankOutlined /></NavLink>),
  ]),
  getItem('Quản Lý Bài Viết', '5', <NavLink  className='text-decoration-none' to="/admin/newsmng"><UserOutlined /></NavLink>),
  getItem('Quản Lý Người Dùng', '6', <NavLink  className='text-decoration-none' to="/admin/users"><UserOutlined /></NavLink>),
]
...
export const AdminTemplate = (props) => { //path, exact, Component
  ...
  const selectedKeys = ['/admin/moviemng','/admin/carouselmng','/admin/theatremng','/admin/theatrechildmng','/admin/users',]
  ...
  return <Route {...restProps} render={(propsRoute,index) => { //props.location, props.history, props.match
        ...
        <Layout>
          ...
          >
            ...
            >
              ...
              <Breadcrumb.Item>{selectedKey === '1' ? 'Quản Lý Người Dùng' : 'Quản Lý Phim'}</Breadcrumb.Item>
            </Breadcrumb>
            <div
              style={{
                padding: 24,
